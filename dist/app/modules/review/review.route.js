...
router.post("/crate", authMiddleWere_1.default.isAuthenticateUser, authMiddleWere_1.default.authorizeRoles("CUSTOMER"), (0, validator_1.validSchema)(review_validation_1.default.create), review_controller_1.default.createReview);
